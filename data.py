...
def readNpy():
    train_image = np.load('data/train/train_image_arr.npy')
    train_GT    = np.load('data/train/train_groundTruth_arr.npy')
    valid_image = np.load('data/train/valid_image_arr.npy')
    valid_GT = np.load('data/train/valid_groundTruth_arr.npy')
